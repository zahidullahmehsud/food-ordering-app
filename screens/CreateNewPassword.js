...
import {strongPassword} from '../utils/ValidationConstraints';
...
const CreateNewPassword = ({navigation, route}) => {
  ...
  console.log('User in create password', username);
          ...
          <View style={[styles.modalContainer]}>
            <View
              ...
              <Text style={styles.modalSubtitle}>
                Make password at least 8 characters: one uppercase, one
