  ...
  return (
    <View
      ...
      <HelpCenterItem
        icon={icons.world}
        title="Website"
        onPress={() => handlePress('https://www.saugeendrives.com/')}
      />
      <HelpCenterItem
        icon={icons.facebook2}
        title="Facebook"
        onPress={() => handlePress('https://www.facebook.com/saugeendrives')}
      />
      {/* <HelpCenterItem
        icon={icons.twitter}
        title="Twitter"
      ...
      <HelpCenterItem
        ...
        title="Instagram"
        onPress={() => handlePress('https://www.instagram.com/saugeendrives/')}
      />
    </View>
  );
};
